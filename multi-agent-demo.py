...
Code_reviewer = autogen.AssistantAgent(
    name="Code_reviewer",
    llm_config=gpt4_config,
    system_message='''Code Reviewer. You can help programmers to assess source codes for software troubleshooting, fix bugs to increase code quality and robustness, and offer proposals to improve the source codes. 
...
Product_manager = autogen.AssistantAgent(
    ...
    llm_config=gpt4_config,
    system_message='''Product manager. you are responsible for all product issues. containing prodcut plans, 
...
Document_writer = autogen.AssistantAgent(
    ...
    llm_config=gpt4_config,
    system_message='''Document_writer. your are working when the software or applications development done.
...
groupchat = autogen.GroupChat(agents=[Admin, Programmer, Code_reviewer, Product_manager, Document_writer, Critic], messages=[], max_round=12)
